  ...
  void calculaImc()
  {
    setState(() {
      ...
      if (imc < 18.5) {
        ...
        mensajes = "PESO Saludable (tu IMC = ${imc.toStringAsPrecision(2)})";
      } else if (imc > 25 && imc < 30){
        mensajes = "PESO Sobrepeso (tu IMC = ${imc.toStringAsPrecision(2)})";
      } else if (imc > 30 && imc < 35){
        mensajes = "PESO Obesidad I (tu IMC = ${imc.toStringAsPrecision(2)})";
      } else if (imc > 35 && imc < 40){
        mensajes = "PESO Obesidad II (tu IMC = ${imc.toStringAsPrecision(2)})";
      } else if (imc > 40){
        mensajes = "PESO Obesidad III (tu IMC = ${imc.toStringAsPrecision(2)})";
      }
    });
  }
  @override
